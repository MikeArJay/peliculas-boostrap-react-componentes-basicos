    ...
    return (
        <Navbar bg="light" expand='md' data-bs-theme="light" sticky="top" className="justify-content-start">
            <Container>
                ...
                <Navbar.Toggle aria-controls="basic-navbar-nav" bg="light" className="me-auto bg-dark"/>
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        <NavDropdown title="Categorías" id="categorias">
                            {categorias
                                && categorias.map((categoria, index) =>
                                    <NavDropdown.Item key={index} as={Link} to={`/${categoria}`}>{categoria}</NavDropdown.Item>
                                )
                            }
                        </NavDropdown>
                        <NavDropdown title="Directores" id="directores">
                            {directores
                                && directores.map((director, index) =>
                                    <NavDropdown.Item key={index} as={Link} to={`/${director}`}>{director}</NavDropdown.Item>
                                )
                            }
                        </NavDropdown>
                    </Nav>
